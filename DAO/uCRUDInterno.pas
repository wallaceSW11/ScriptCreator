...
uses
  ...
  ZConnection, ZDbcIntfs, Vcl.Dialogs, System.TypInfo, //uFactoryConnection
  Winapi.Windows, uConexaoLocal;
...
type
  ...
  private
    ...
    //class function RetornarListaObjetoPreenchido(pQuery: TZQuery): TObjectList; static;

  public
   // class function Select(pComando: string):Tobjectlist;
...
class function TCRUDInterno.IniciarConsulta(pComando: string):TZQuery;
var
  lQuery : TZQuery;
begin
  lQuery := TZQuery.Create(nil);
  lQuery.Connection := TConexaoLocal.Conectar;
...
class function TCRUDInterno.SelectSimples(pComando: string): string;
var
  lQuery: TZQuery;
begin
    ...
    try
      ...
      on e:Exception do
        ShowMessage('Falha na consulta ' + E.ClassName+
                    ' error raised, with message : '+E.Message +#13+
                    'Comando:' + #13+pcomando);
    end;
...
//class function TCRUDInterno.Select(pComando: string):Tobjectlist;
//var
//  lQuery : TZQuery;
//begin
//   lQuery := IniciarConsulta(pComando);
...
//class function TCRUDInterno.ConsultaValida(pQuery: TZQuery; pComando: string):Boolean;
//begin
//  Result := False;
//
//  try
...
//class function TCRUDInterno.RetornarListaObjetoPreenchido(pQuery: TZQuery): TObjectList;
//var
//  lQuery : TZQuery;
//  ctx: TRttiContext;
//  tipo: TRttiType;
...
//class function TCRUDInterno.SelectObj(pComando: string):TObject;
//var
//  lQuery : TZQuery;
//  ctx: TRttiContext;
//  tipo: TRttiType;
...
//class function TCRUDInterno.SelectIfExists(pComando: string): Boolean;
//var
//  lQuery: TZQuery;
//begin
//  lQuery := IniciarConsulta(pComando);
...
//class procedure TCRUDInterno.Delete(pComando: string);
//var
//  lQuery: TZQuery;
//begin
//  lQuery := IniciarConsulta(pComando);
...
//class function TCRUDInterno.Insert(pComando: string): Boolean;
//var
//  lQuery: TZQuery;
//begin
//  lQuery := IniciarConsulta(pComando);
...
class function TCRUDInterno.Update(pComando: string): Boolean;
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
