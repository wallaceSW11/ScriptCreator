...
uses
  ...
  ZConnection, ZDbcIntfs, Vcl.Dialogs, uFabricaConexaoInterno, System.TypInfo,
  Winapi.Windows;


type
  TCRUD_Interno<T:Class> = class
  private
  ...
  public
    ...
    class function CreateBase(pComando: string): Boolean; static;
...
class function TCRUD_Interno<T>.IniciarConsulta(pComando: string):TZQuery;
var
  lQuery : TZQuery;
begin
  lQuery := TZQuery.Create(nil);
  lQuery.Connection := TFabricaConexaoInterno.Conectar;
...
class function TCRUD_Interno<T>.Select(pComando: string):Tobjectlist<T>;
var
  lQuery : TZQuery;
begin
...
class function TCRUD_Interno<T>.ConsultaValida(pQuery: TZQuery; pComando: string):Boolean;
begin
  Result := False;
...
class function TCRUD_Interno<T>.RetornarListaObjetoPreenchido(pQuery: TZQuery): TObjectList<T>;
var
  lQuery : TZQuery;
  ctx: TRttiContext;
  tipo: TRttiType;
...
class function TCRUD_Interno<T>.SelectObj(pComando: string):TObject;
var
  lQuery : TZQuery;
  ctx: TRttiContext;
  tipo: TRttiType;
...
class function TCRUD_Interno<T>.SelectIfExists(pComando: string): Boolean;
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
...
class function TCRUD_Interno<T>.SelectSimples(pComando: string): string;
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
...
class procedure TCRUD_Interno<T>.Delete(pComando: string);
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
...
class function TCRUD_Interno<T>.Insert(pComando: string): Boolean;
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
...
class function TCRUD_Interno<T>.CreateBase(pComando: string): Boolean;
var
  lQuery: TZQuery;
begin
...
class function TCRUD_Interno<T>.Update(pComando: string): Boolean;
var
  lQuery: TZQuery;
begin
  lQuery := IniciarConsulta(pComando);
